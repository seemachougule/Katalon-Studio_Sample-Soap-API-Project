...
response1 = WS.sendRequest(findTestObject('Conunty Info Service/GetCountrylist by Name'))
...
WS.sendRequest(findTestObject('Conunty Info Service/GetCapital', [('CountryISOCode') : GlobalVariable.countryCode]))
